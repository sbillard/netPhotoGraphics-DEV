...
<form id="mailform" class="remove-bottom" action="<?php echo sanitize($_SERVER['REQUEST_URI']); ?>" method="post" accept-charset="UTF-8">
	...
	<?php if (showOrNotShowField(getOption('contactform_title'))) { ?>
		<div>
			...
			<input type="text" id="title" name="title" size="50" value="<?php echo html_encode($mailcontent['title']); ?>"<?php if ($_processing_post) {
...
?> />
	...
	<?php if (showOrNotShowField(getOption('contactform_name'))) { ?>
		<div>
			...
			<input type="text" id="name" name="name" size="50" value="<?php echo html_encode($mailcontent['name']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_company'))) { ?>
		<div>
			...
			<input type="text" id="company" name="company" size="50" value="<?php echo html_encode($mailcontent['company']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_street'))) { ?>
		<div>
			...
			<input type="text" id="street" name="street" size="50" value="<?php echo html_encode($mailcontent['street']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_city'))) { ?>
		<div>
			...
			<input type="text" id="city" name="city" size="50" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_state'))) { ?>
		<div>
			...
			<input type="text" id="state" name="state" size="50" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_coundivy'))) { ?>
		<div>
			...
			<input type="text" id="coundivy" name="coundivy" size="50" value="<?php echo html_encode($mailcontent['coundivy']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_postal'))) { ?>
		<div>
			...
			<input type="text" id="postal" name="postal" size="50" value="<?php echo html_encode($mailcontent['postal']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_email'))) { ?>
		<div>
			...
			<input type="text" id="email" name="email" size="50" value="<?php echo html_encode($mailcontent['email']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_website'))) { ?>
		<div>
			...
			<input type="text" id="website" name="website" size="50" value="<?php echo html_encode($mailcontent['website']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<?php if (showOrNotShowField(getOption('contactform_phone'))) { ?>
		<div>
			...
			<input type="text" id="phone" name="phone" size="50" value="<?php echo html_encode($mailcontent['phone']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
		</div>
	...
	<div>
		...
		<input type="text" id="subject" name="subject" size="50" value="<?php echo html_encode($mailcontent['subject']); ?>"<?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
?> />
	</div>
	...
	<div>
		...
		<textarea id="message" name="message" rows="5" cols="39" <?php if ($_processing_post) {
	echo ' disabled="disabled"';
}
